    ...
    <div className="border-b border-white/5 pb-3">
      {message ? (
        <div className="p-4 bg-[var(--accent)]/10 border border-[var(--accent)]/20 mb-2">
            <p className="font-mono text-[11px] text-[var(--accent)] leading-relaxed uppercase tracking-wider">
                {message}
            </p>
        </div>
      ) : (
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-[var(--accent)] text-black text-[11px] font-black uppercase tracking-[0.2em] hover:opacity-90 transition-all disabled:opacity-30"
          >
