  ...
  return (
    <>
      <nav className="fixed top-0 w-full z-50 bg-[#0a0a0a]/80 backdrop-blur-md px-4 h-[50px] flex justify-between items-center border-b border-white/5">
        <Link href="/" className="font-black text-xl sm:text-2xl tracking-tighter uppercase italic group leading-[0.85] flex-shrink-0 flex flex-col sm:flex-row sm:gap-x-1.5 items-start sm:items-center">
          <span>Dark</span>
          <span className="text-[var(--accent)] ml-[15px] sm:ml-0 group-hover:brightness-110 transition-all duration-300 ease-[cubic-bezier(0.4, 0, 0.2, 1)]">Factory</span>
        </Link>
        
        <div className="flex gap-[clamp(0.75rem,3vw,2rem)] text-[10px] items-center font-mono uppercase tracking-widest text-[#666] min-w-0 ml-3 sm:ml-0">
          <Link 
            href="/shop" 
