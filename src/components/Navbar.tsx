  ...
  return (
    <>
      <nav className="fixed top-0 w-full z-50 bg-[#0a0a0a]/80 backdrop-blur-md px-4 h-[50px] flex justify-between items-center border-b border-white/5">
        <Link href="/" className="font-black text-xl md:text-2xl tracking-tighter uppercase italic group leading-[0.85] flex-shrink-0 flex flex-col md:flex-row items-start md:items-center">
          <span>Dark</span>
          <span className="text-[var(--accent)] ml-5 group-hover:brightness-110 transition-all duration-300 ease-[cubic-bezier(0.4, 0, 0.2, 1)]">Factory</span>
        </Link>
