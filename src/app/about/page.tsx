            ...
            <ul className="space-y-4 text-xl font-black italic tracking-tighter uppercase">
              {[
                ...
                <li key={i} className="flex flex-col sm:flex-row sm:justify-between sm:items-baseline group cursor-help transition-all duration-300 py-3 border-b border-white/5 sm:border-transparent sm:hover:border-white/5 overflow-hidden">
                  <span className="text-[var(--accent)] mb-1 sm:mb-0">
                    {pillar.label}
                  </span>
                  <div className="grid justify-items-end">
                    <span className="col-start-1 row-start-1 text-base sm:text-xl text-white/20 font-mono tracking-widest group-hover:opacity-0 transition-opacity duration-300 whitespace-nowrap text-right">
                      Verified
                    </span>
                    <span className="col-start-1 row-start-1 text-base sm:text-xl text-[var(--accent)] font-mono tracking-widest opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-normal text-right pointer-events-none leading-tight max-w-[280px] sm:max-w-[400px]">
                      {pillar.detail}
                    </span>
                  </div>
                </li>
