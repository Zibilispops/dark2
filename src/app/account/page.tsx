    ...
    <main className="min-h-screen bg-[#080808] text-white pt-12 pb-20 px-6 md:px-12">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        <div className="p-8 bg-[#0c0c0c] border border-white/5 col-span-2">
          <h2 className="font-mono text-[10px] uppercase tracking-widest text-[#444] mb-4">
            [ Operator Profile ]
          </h2>
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center border-b border-white/5 pb-3">
              <span className="font-mono text-[10px] uppercase tracking-widest text-[#555]">Joined</span>
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-[10px] font-mono text-[var(--accent)] border border-[var(--accent)]/30 px-2 py-0.5">ACTIVE</span>
            </div>
          </div>
        </div>
        ...
        <div className="p-8 bg-[#0c0c0c] border border-white/5 flex flex-col justify-between">
          <div>
            ...
            <div className="space-y-3">
              <Link
                href="/shop"
                className="block w-full text-center py-3 border border-white/10 text-xs font-mono uppercase tracking-widest text-[#666] hover:border-[var(--accent)] hover:text-[var(--accent)] transition-all"
              >
                Browse Collection
              </Link>
            </div>
      ...
      <section>
        ...
        {(!orders || orders.length === 0) ? (
          <div className="p-16 bg-[#0c0c0c] border border-white/5 text-center">
            <p className="text-[#333] font-mono text-xs uppercase tracking-widest mb-4">
              No orders yet
            </p>
            <Link href="/shop" className="btn-primary inline-block px-8 py-3 text-xs">
              Start Shopping →
            </Link>
          </div>
        ) : (
